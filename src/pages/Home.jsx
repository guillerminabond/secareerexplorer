...
{ title: "CPD Career Resources",            url: "https://my.hbs.edu/cpd",                                                                                                  desc: "HBS Career & Professional Development tools and employer database.",                                              tags: ["Career Support"],                     featured: false },
...
{ title: "12twenty Networking",             url: "https://mba-business-harvard.12twenty.com/mentorships/home",                                                                    desc: "HBS platform to find and request mentorship from alumni across sectors.",                                        tags: ["Mentorship", "Alumni"],               featured: false },
...
{ title: "AI-Powered Opportunities & Connections Platform (OCP)", url: "https://cpd.dtxchat.org/",                                                                                            desc: "CPD's 2025 AI-powered job search tool. Run a conversational search to find roles and surface HBS alumni at hiring companies — sorted by relevance, recency, alumni presence, or salary. Log in with HBS credentials.", tags: ["Career Support", "Alumni"], featured: false },
{ title: "CPD Climate & Sustainability Resources", url: "https://my.hbs.edu/cpd/tools-resources/climate-sustainability-resources",                                                            desc: "CPD's hub for climate, cleantech, energy, and sustainability careers — specialized coaching, curated job listings, alumni speed-networking events, and Baker Library research access. Co-built with the HBS Business & Environment Initiative.", tags: ["Career Support", "Research"], featured: false },
{ title: "CPD Career Coach Directory",            url: "https://inside.hbs.edu/Departments/mba/cpd/directory.aspx?LocalFacet2=Social%20Enterprise",                                             desc: "Find CPD career coaches who specialize in social enterprise — filter by sector focus and book appointments.",      tags: ["Mentorship", "Career Support"],       featured: false },
{ title: "12twenty",                              url: "https://mba-business-harvard.12twenty.com/",                                                                                            desc: "HBS's career platform with employment data, recruiting timelines, job sources, job postings, employer events, and more — a go-to hub for SE career planning.",  tags: ["Career Support"],                     featured: false },
];
...
// (AdminAuthModal is imported from @/components/AdminAuthModal)
...
export default function Home() {
  ...
  // Admin state — adminMode is driven by Supabase Auth via AdminContext
  const { adminMode, logout: adminLogout } = useAdmin();
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {showAdminAuth && (
        <AdminAuthModal
          onSuccess={() => setShowAdminAuth(false)}
