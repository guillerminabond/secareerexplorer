...
const CAUSE_DETAILS = {
  "Poverty Alleviation": {
    ...
    hbs_pathway: {
      ...
      courses: [
        ...
        "Business Solutions for the Poor",
        "Social Entrepreneurship and Systems Change",
      ],
      clubs: ["Social Enterprise Club", "Consulting for Impact Club", "LatAm Club"],
    },
    sdg_links: [
  ...
  "Economic Development": {
    ...
    hbs_pathway: {
      ...
      clubs: ["Social Enterprise Club", "Africa Business Club", "South Asian Business Association"],
    },
    sdg_links: [
  ...
  "Global Health": {
    ...
    hbs_pathway: {
      ...
      clubs: ["Health Care Club", "Social Enterprise Club"],
    },
    sdg_links: [
  ...
  "Education": {
    ...
    hbs_pathway: {
      ...
      clubs: ["Education Club", "Social Enterprise Club", "First Generation Students Club"],
    },
    sdg_links: [
  ...
  "Climate & Energy": {
    ...
    hbs_pathway: {
      text: "HBS MBAs are highly sought after in climate tech venture capital, corporate sustainability leadership, climate policy consulting, and clean energy infrastructure finance. The Energy & Climate Club and Food and Agriculture Club offer community and recruiting connections.",
      courses: [
        "Reweaving Ourselves and the World",
        "Global Climate Change",
        "Energy",
        "Sustainable Investing",
      ],
      clubs: ["Energy & Climate Club", "Food and Agriculture Club", "Social Enterprise Club"],
    },
    sdg_links: [
  ...
  "Gender & Social Justice": {
    ...
    hbs_pathway: {
      text: "HBS MBAs in this space tend to work at gender-lens investing funds, women's economic empowerment organizations, foundations focused on racial equity, or social justice advocacy organizations. The Women's Student Association, PRIDE, and African American Student Union offer strong community.",
      courses: [
        "Power and Influence for Positive Impact",
        "Social Entrepreneurship and Systems Change",
        "Business Solutions for the Poor",
      ],
      clubs: ["Women's Student Association", "African American Student Union", "PRIDE"],
    },
    sdg_links: [
  ...
  "Financial Inclusion": {
    ...
    hbs_pathway: {
      ...
      clubs: ["FinTech Club", "Impact Investing Club", "Social Enterprise Club"],
    },
    sdg_links: [
      { label: "SDG 10: Reduced Inequalities", url: `${SDG_BASE}10` },
      { label: "SDG 1: No Poverty", url: `${SDG_BASE}1` },
  ...
  "Housing & Community": {
    ...
    hbs_pathway: {
      text: "HBS MBAs engage through community development financial institutions (CDFIs), affordable housing developers, urban planning consultancies, and real estate impact funds. The Real Estate Club often connects students to impact-focused developers and investors.",
      courses: [
        "Real Property",
        "Public Entrepreneurship",
        "Social Entrepreneurship and Systems Change",
      ],
      clubs: ["Real Estate Club", "Government & Public Policy Club", "Social Enterprise Club"],
    },
    sdg_links: [
  ...
  "Arts & Culture": {
    ...
    hbs_pathway: {
      ...
      clubs: ["Art Society", "Entertainment & Media Club", "Social Enterprise Club"],
    },
    sdg_links: [
      { label: "SDG 11: Sustainable Cities & Communities", url: `${SDG_BASE}11` },
      { label: "SDG 4: Quality Education", url: `${SDG_BASE}4` },
