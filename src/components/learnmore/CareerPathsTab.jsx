...
const DEFAULT_CAREER_RESOURCES = {
  ...
  "Strategy Consultant (Social Sector)": [
    ...
    { title: "BCG Social Impact", url: "https://www.bcg.com/capabilities/social-impact/overview", desc: "BCG's social impact consulting practice and fellowship" },
  ],
  "Grants Officer": [
    { title: "Candid Learning", url: "https://learning.candid.org/", desc: "Candid's hub for grant seekers, program officers, and funders (formerly GrantSpace)" },
  ...
  "Policy Advisor": [
    ...
    { title: "White House Fellows", url: "https://whff.org/the-program/", desc: "Prestigious public service leadership program" },
  ],
  "Corporate Sustainability Lead": [
    ...
    { title: "SASB Standards (IFRS)", url: "https://www.ifrs.org/issued-standards/sasb-standards/", desc: "Industry-specific sustainability accounting standards, now maintained by IFRS" },
  ...
  "Development Director": [
    ...
    { title: "Network for Good (Bonterra)", url: "https://www.bonterratech.com/product/network-for-good", desc: "Tools and learning resources for nonprofit fundraising teams" },
